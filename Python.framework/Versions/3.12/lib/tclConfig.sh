...
TCL_EXTRA_CFLAGS='-arch arm64 -arch x86_64 -I/tmp/_py/libraries/usr/local/include -pipe   -mmacosx-version-min=10.13 '
...
# build directory.
TCL_BUILD_LIB_SPEC='-L/private/tmp/_py/_bld/tcl8.6.15/unix -ltcl8.6'

# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='-L/Library/Frameworks/Python.framework/Versions/3.12/lib -ltcl8.6'
...
# compiled.
TCL_SRC_DIR='/private/tmp/_py/_bld/tcl8.6.15'

# List of standard directories in which to look for packages during
# "package require" commands.  Contains the "prefix" directory plus also
# the "exec_prefix" directory, if it is different.
TCL_PACKAGE_PATH='/Library/Frameworks/Python.framework/Versions/3.12/lib:/usr/local/lib'
...
# build directory.
TCL_BUILD_STUB_LIB_SPEC='-L/private/tmp/_py/_bld/tcl8.6.15/unix -ltclstub8.6'

# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-L/Library/Frameworks/Python.framework/Versions/3.12/lib -ltclstub8.6'

# Path to the Tcl stub library in the build directory.
TCL_BUILD_STUB_LIB_PATH='/private/tmp/_py/_bld/tcl8.6.15/unix/libtclstub8.6.a'

# Path to the Tcl stub library in the install directory.
TCL_STUB_LIB_PATH='/Library/Frameworks/Python.framework/Versions/3.12/lib/libtclstub8.6.a'
