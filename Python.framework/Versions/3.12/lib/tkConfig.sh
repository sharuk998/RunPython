...
# build directory.
TK_BUILD_LIB_SPEC='-L/private/tmp/_py/_bld/tk8.6.15/unix -ltk8.6'

# String to pass to linker to pick up the Tk library from its
# installed directory.
TK_LIB_SPEC='-L/Library/Frameworks/Python.framework/Versions/3.12/lib -ltk8.6'
...
# compiled.
TK_SRC_DIR='/private/tmp/_py/_bld/tk8.6.15'
...
# build directory.
TK_BUILD_STUB_LIB_SPEC='-L/private/tmp/_py/_bld/tk8.6.15/unix -ltkstub8.6'

# String to pass to linker to pick up the Tk stub library from its
# installed directory.
TK_STUB_LIB_SPEC='-L/Library/Frameworks/Python.framework/Versions/3.12/lib -ltkstub8.6'

# Path to the Tk stub library in the build directory.
TK_BUILD_STUB_LIB_PATH='/private/tmp/_py/_bld/tk8.6.15/unix/libtkstub8.6.a'

# Path to the Tk stub library in the install directory.
TK_STUB_LIB_PATH='/Library/Frameworks/Python.framework/Versions/3.12/lib/libtkstub8.6.a'
